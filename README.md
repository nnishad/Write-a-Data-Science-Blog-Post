...
1. What are the most used programming languages? </br>
2. What are the most wanted programming languages? </br>
...
The main findings of the code can be found at the post available [here](https://medium.com/@nikhilnishad279/most-common-programming-languages-91112d035989)
